...
public class AddActorTest {
  ...
  public void addActor() {
    ...
    driver.findElement(By.id("nombre")).sendKeys("AAAAA");
    driver.findElement(By.id("apellidos")).sendKeys("ACTOR");
    ...
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(1)")).getText(), is("AAAAA ACTOR"));
  }
}
